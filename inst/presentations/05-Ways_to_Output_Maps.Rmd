...
- Save to a static image in one of the raster formats.<br/><br/>`.jpg`/`.bmp` use lossy & `.tiff`/`.png` use lossless compression. (TIFF are huge!)
...
- For rockstar status mapping you can combine `htmlwidgets` + `crosstalk` + `shiny`.

...
- `rgeos` / `gdistance` / `geosphere` / `maptools`:<br/>Contain many geometry and feature related operations.
...
```{r 04-05, fig.height=5, fig.align='center'}
...
```{r 04-07, fig.align='center', fig.width=12,fig.height=6}
{{ r_log <- calc(r, log) }}

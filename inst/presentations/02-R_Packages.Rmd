...
- base plotting: Very Powerful .gray[<sup>1</sup>], but not intuitive (IMHO). Many viz. packages provide extensions on top of this.
...
- [ggiraph](https://cran.r-project.org/package=ggiraph) / [gganimate](https://github.com/dgrtwo/gganimate) / [animation](https://cran.r-project.org/package=animation): Convert ggplot2 charts to interactive charts.
